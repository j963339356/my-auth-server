...
import com.auth.demo.common.ResultCodeEnum;
...
import com.auth.demo.service.impl.UserInfoValidServiceImpl;
...
public class UserinfoController {
    ...
    @ResponseBody
    public CommonResult<UserInfoDto> userinfo(@PathVariable("id") String id){
    ...
    @ResponseBody
    public CommonResult<Object> updateUser(@PathVariable("id") String id, @RequestBody UserInfoDto userInfoDto){
        CommonResult commonResult;
